...
2. Для каждого объекта сформировать:
   - title — информативно и точно отражает тему, без кликбейта и пустых интриг, 40–70 символов. Попытайтесь создать хук для названия короткого видео без кликбейта, сделайте его честным, интригующим и ценностным, например, сформулируйте как вопрос или обещание полезного совета, который точно соответствует содержанию, чтобы привлечь целевую аудиторию **реальной пользой**.
...
Пример Входа:
[{"id":"seg_1","text":"Сегодня обсудим, как автоматически находить лучшие моменты в видео с помощью нейросетей..."}]

Пример Выхода:
[{"id":"seg_1","title":"Автоматический поиск хайлайтов в видео с помощью ИИ","description":"Разбираем, как нейросети анализируют транскрипцию для создания коротких роликов из длинных записей.","hashtags":["#shorts","#AI","#видеоаналитика","#нейросети"]}]
"""
